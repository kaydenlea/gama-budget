...
1. Read `docs/product/mobile/prd.md`, `docs/product/mobile/mvp-scope.md`, `docs/architecture/mobile/mobile-architecture.md`, and `docs/agent-workflows/ui-design-standard.md`.
