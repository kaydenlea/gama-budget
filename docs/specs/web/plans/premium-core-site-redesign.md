...
- the latest metadata follow-up kept the same launch-lane scope but updated root social metadata text and added versioned OG/Twitter image URLs so share surfaces pick up the new positioning instead of reusing older cached previews
